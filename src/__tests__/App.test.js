...
test("'Contact Info' text box initially displays a placeholder value for 'email address'" , () => {
  render(<App />)
...
test("the page shows information the user types into the contact form field", () => {
  ...
  userEvent.type(contact, "pizzefan@email.com")

  expect(contact).toHaveValue("pizzefan@email.com")
})
// Submit Order button
test("form contain a 'Submit Order' button", () => {
  render(<App />)
